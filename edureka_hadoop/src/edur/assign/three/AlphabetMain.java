...
public class AlphabetMain {
	public static class Map extends MapReduceBase implements Mapper<LongWritable, Text, Text, IntWritable>{
		...
		public void map(LongWritable key, Text value, OutputCollector<Text, IntWritable> output, Reporter report)throws IOException {
			HadoopUtil.mapAlphabets(key, value, output, report);
		}
	...
	public static void main(String[] arg) {
		try{
			HadoopUtil.runJob(WordCountMain.class, "myAphabetLenCount", Text.class, IntWritable.class, Map.class, Reduce.class, TextInputFormat.class, TextOutputFormat.class, arg[0], arg[1]);			
